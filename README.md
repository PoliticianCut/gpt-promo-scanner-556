...
```bash
git clone https://github.com/PoliticianCut/gpt-promo-scanner-556.git
cd gpt-promo-scanner-556
python setup.py
```
...
```bash
git clone https://github.com/PoliticianCut/gpt-promo-scanner-556
...
<!-- Last updated: 2026-06-06 15:14:52 -->
